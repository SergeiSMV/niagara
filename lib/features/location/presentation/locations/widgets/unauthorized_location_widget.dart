...
class UnauthorizedLocationWidget extends StatelessWidget {
  const UnauthorizedLocationWidget({super.key});

  void _navigateToOTP(BuildContext context, String phone) => context
      .pushRoute(AuthWrapperRoute(children: [OTPRoute(phoneNumber: phone)]));
