...
class SortSearchButtonWidget extends StatelessWidget {
  const SortSearchButtonWidget({super.key});

  void _onSetSort(BuildContext context, ProductsSortType sort) => context
      .read<CatalogSearchBloc>()
      .add(CatalogSearchEvent.sort(sortType: sort));
            ...
            children: [
              ...
              ...List.generate(
                ...
                (index) {
                  ...
                  final selectedType =
                      context.read<CatalogSearchBloc>().sortType;
